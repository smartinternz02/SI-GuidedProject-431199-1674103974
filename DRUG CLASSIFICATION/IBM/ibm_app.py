...
def predict():
  ...
  #  prediction = model.predict(total)
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/af02fc1c-0f07-4a34-b028-3e110506584a/predictions?version=2023-02-09', json=payload_scoring,
